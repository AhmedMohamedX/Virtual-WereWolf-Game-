...
public class PlayerNetwork : MonoBehaviour {
    ...
    float timeLeft =5, timeLeftvo = 5, timeLeftsa=5, timeLeftso=5, timeLeftni=5;
    private void Awake()
    {
        Instance = this;
    ...
    */
    ...
    private void RPC_victory()
    {
        ...
        GameObject fok3alazebi = new GameObject();
        fok3alazebi.transform.position = new Vector3(111.5862f, 7.09f, 318.6533f);
        Camera.main.GetComponent<CameraFollow>().setTarget(fok3alazebi.transform);
